...
def simple_calculator():
    ...
    operator = input("Okay, now let us understand what you want to do with these numbers.\nYou can input this operations: + - * / ** %\n")
    while (operator.strip() != "+") and (operator.strip() != "-") and (operator.strip() != "*") and (operator.strip() != "/") and (operator.strip() != "**") and (operator.strip() != "%"):
        operator = input("Okay, now let us understand what you want to do with these numbers.\nYou can input this operations: + - * / ** %\n")

    if operator.strip() == "+":
        print("Result of this operation is equal to: "+str(first_number+second_number))
    if operator.strip() == "-":
        print("Result of this operation is equal to: "+str(first_number-second_number))
    if operator.strip() == "*":
        print("Result of this operation is equal to: "+str(first_number*second_number))
